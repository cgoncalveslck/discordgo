...
[![Go Reference](https://pkg.go.dev/badge/github.com/cgoncalveslck/discordgo.svg)](https://pkg.go.dev/github.com/cgoncalveslck/discordgo) [![Go Report Card](https://goreportcard.com/badge/github.com/cgoncalveslck/discordgo)](https://goreportcard.com/report/github.com/cgoncalveslck/discordgo) [![CI](https://github.com/cgoncalveslck/discordgo/actions/workflows/ci.yml/badge.svg)](https://github.com/cgoncalveslck/discordgo/actions/workflows/ci.yml) [![Discord Gophers](https://img.shields.io/badge/Discord%20Gophers-%23discordgo-blue.svg)](https://discord.gg/golang) [![Discord API](https://img.shields.io/badge/Discord%20API-%23go_discordgo-blue.svg)](https://discord.com/invite/discord-api)
...
```sh
go get github.com/cgoncalveslck/discordgo
```
...
```go
import "github.com/cgoncalveslck/discordgo"
```
...
- [![Go Reference](https://pkg.go.dev/badge/github.com/cgoncalveslck/discordgo.svg)](https://pkg.go.dev/github.com/cgoncalveslck/discordgo) 
...
- [DiscordGo Examples](https://github.com/cgoncalveslck/discordgo/tree/master/examples) - A collection of example programs written with DiscordGo
- [Awesome DiscordGo](https://github.com/cgoncalveslck/discordgo/wiki/Awesome-DiscordGo) - A curated list of high quality projects using DiscordGo

## Troubleshooting
For help with common problems please reference the 
[Troubleshooting](https://github.com/cgoncalveslck/discordgo/wiki/Troubleshooting) 
